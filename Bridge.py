...
line2 = myFont2.render("搭建方法@ 选择钢材     /木材     /道路     ，从标记点", True, (0, 0, 0))
line3 = myFont2.render("或桥梁的节点处开始搭建，按下左键并拖动鼠标，", True, (0, 0, 0))
line4 = myFont2.render("释放左键搭建完毕，单击右键可删除已搭建的部分", True, (0, 0, 0))
line5 = myFont2.render("测评方法@ 点击左侧     开始测评，小车顺利到达对岸即视为", True, (0, 0, 0))
line6 = myFont2.render("成功，允许桥梁在行驶中坍塌，小车不能落水", True, (0, 0, 0))
line7 = myFont2.render("注意事项@ 道路坡度不得大于45度", True, (0, 0, 0))
line8 = myFont2.render("同一竖直方向不能有道路重叠", True, (0, 0, 0))
line9 = myFont2.render("材料总费用不能超过预算", True, (0, 0, 0))
line10 = myFont2.render("小车仅可在道路上行驶，不可在钢梁或木材上行驶", True, (0, 0, 0))
...
for pic in range(0, CoverPicture[-1]):
    ...
    for event in pygame.event.get():
        if event.type == QUIT:
            exit()
    picture = pygame.image.fromstring(CoverPicture[pic], (625, 365), 'RGB')
...
def main():
    ...
    while True:
        ...
        if bri.option == 5:
            ...
            surface2.blit(line1, (80, 60))
            surface2.blit(line2, (80, 90))
            surface2.blit(line3, (170, 120))
            surface2.blit(line4, (170, 150))
            surface2.blit(line5, (80, 180))
            surface2.blit(line6, (170, 210))
            surface2.blit(line7, (80, 240))
            surface2.blit(line8, (170, 270))
            surface2.blit(line9, (170, 300))
            surface2.blit(line10, (170, 330))
            surface2.blit(steel, (243, 79))
            surface2.blit(wood, (333, 79))
            surface2.blit(road, (423, 79))
            surface2.blit(point, (559, 95))
            surface2.blit(begin, (243, 168))
        elif bri.option == 6:
            surface2.fill((255, 255, 255, 150))
